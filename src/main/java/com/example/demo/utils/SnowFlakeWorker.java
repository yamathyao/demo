...
public class SnowFlakeWorker {
     ...
     * 数据中心数量占的位数
     */
    private static final long DATA_CENTER_BITS = 1;
    /**
     * 计算机数量占的位数
     */
    private static final long WORKER_BITS = 1;
    /**
     * 序列占的位数
     */
    private static final long SEQUENCE_BITS = 1;
    ...
    public synchronized long nextId() {
        ...
        return ((timestamp - START_TIME) % 100000 << TIME_BIT_OFFSET)
...
////            String sId = String.valueOf(nextId);
////            String id = sId.substring(sId.length() - 6);
