...
public final class RsaReadUtil {
    ...
    public static PublicKey getPublicKeyFromFile(String pubCerPath) throws Exception {
        ...
        try {
            ...
            throw new IOException("公钥文件读取失败");
        } catch (Exception e) {
     ...
     * @return
     */
    public static PublicKey getPublicKeyByText(String pubKeyText) throws CertificateException, IOException {
        try {
            ...
            throw new CertificateException("解析公钥内容失败");
        } catch (IOException e) {
            log.error("读取内容失败", e);
            throw new IOException("读取内容失败");
        }
    }
